...
typedef enum { FlipNone, FlipHorizontal, FlipVertical } Flip;
...
DE_API void DE_Sprite_BlitPartialScaled(
    vec4 rect, vec4 dim, vec2 scale, double angle, Flip flip, DeccanSpriteAsset *texture);
