...
void DE_Renderer_draw_point2(int32_t x, int32_t y, Deccan_Color color);
void DE_Renderer_draw_line(Deccan_Vector2i start, Deccan_Vector2i end, Deccan_Color color);
void DE_Renderer_draw_line2(int32_t x1, int32_t y1, int32_t x2, int32_t y2, Deccan_Color color);
