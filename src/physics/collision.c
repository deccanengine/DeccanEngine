    ...
    */
    ...
    if(type1 == type2) {
        switch(type1) {
            ...
            case ColliderVec: {
                DE_Vector2i v1 = {obj1->position.x + obj1->collider.vec.x, obj1->position.y + obj1->collider.vec.y}; 
                DE_Vector2i v2 = {obj2->position.x + obj2->collider.vec.x, obj2->position.y + obj2->collider.vec.y}; 
    ...
    if(case_1 || case_2) {
        ...
        /* v & r */
        if(case_1) {
            vec  = (DE_Vector2i){obj1->position.x + obj1->collider.vec.x,   obj1->position.y + obj1->collider.vec.y};
            rect = (DE_PosRect) {obj2->position.x + obj2->collider.rect.x1, obj2->position.y + obj2->collider.rect.y1,
                                     obj2->position.x + obj2->collider.rect.x2, obj2->position.y + obj2->collider.rect.y2};
        }
        /* r & v   */
        else {
            vec  = (DE_Vector2i){obj2->position.x + obj2->collider.vec.x,   obj2->position.y + obj2->collider.vec.y};
